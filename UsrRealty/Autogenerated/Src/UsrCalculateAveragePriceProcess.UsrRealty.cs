namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAveragePriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAveragePriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalculateAveragePriceProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var offerTypeFilter = esq.CreateFilterWithParameters(FilterComparisonType.Equal, "UsrRealtyOfferType", offerTypeId);
